...
--	habit à partir des données positions
...
DECLARE
		...
		t_week integer; -- la semaine de l'année
		current_week integer; -- la semaine courante du traitement

BEGIN
		current_week:=0;
		-- Récupérer tous les enregistrements dans la table position
			...
			-- Pour chaque position
                ...
                EXIT WHEN NOT FOUND;
                        ...
                        LOOP
                                ...
                                EXIT WHEN NOT FOUND;
										-- Appel à la procédure stockée insertweeklyhabit
