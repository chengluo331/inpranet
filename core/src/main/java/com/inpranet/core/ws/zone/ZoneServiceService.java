...
@WebServiceClient(name = "ZoneServiceService", 
                  wsdlLocation = "file:/home/yoann/workspace/inpranet2/core/src/main/resources/zone.wsdl",
...
public class ZoneServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/yoann/workspace/inpranet2/core/src/main/resources/zone.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/home/yoann/workspace/inpranet2/core/src/main/resources/zone.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
