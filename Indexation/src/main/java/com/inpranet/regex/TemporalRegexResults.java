...
public class TemporalRegexResults extends RegexResults<Date> {
	 ...
	 * (cas où on a que des indications sur les heures mais pas de jour en particulier)
	 */
	 ...
	 * (cas où on n'a pas d'indications sur l'annee en particulier)
	 */
	 ...
	 * De plus, si l'heure n'est pas indiquee, fixe celle-ci à minuit (00:00)
...
//				formatMapper = _formatMapper;
		...
		// La date de debut commence par defaut à 00:00 si aucune heure n'a ete trouvee
